...
inline const FieldTable<DiodeRow>& fields<DiodeRow>() {
    static const FieldTable<DiodeRow> t{
        {{"vrrm_rated", &DiodeRow::vrrm_rated},
         ...
         {"qrr", &DiodeRow::qrr},
         {"trr", &DiodeRow::trr},
         {"vz_min", &DiodeRow::vz_min},
         {"vz_max", &DiodeRow::vz_max},
         {"vz_tolerance", &DiodeRow::vz_tolerance},
